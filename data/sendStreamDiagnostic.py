    ...
    while True:
        ...
        try:
            ...
            if firstline is True:
                ...
                timestamp, routerId, queuedPackets, packetsServed, temperature = line1[
                    0], int(line1[1]), int(line1[2]), int(line1[3]), float(
                        line1[4])
                # Convert csv columns to key value pair
                msg = {}
                msg['timestamp'] = timestamp
                msg['routerId'] = routerId
                msg['queuedPackets'] = queuedPackets
                msg['packetsServed'] = packetsServed
                ...
                timestamp, routerId, queuedPackets, packetsServed, temperature = line[
                    0], int(line[1]), int(line[2]), int(line[3]), float(
                        line[4])
                msg = {}
                msg['timestamp'] = timestamp
                msg['routerId'] = routerId
